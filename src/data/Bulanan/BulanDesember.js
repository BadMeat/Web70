const bulanDesember = {
    ...
    kunjungan: [
        ...
        {jenisAnggota: 'Siswa', jumlahPengunjung: 83},
    ],
    kunjunganRombel: [
        {kelas: '-', mataPelajaran: "-", jumlahSiswa: "-"}
    ],
    sirkulasi: [
        {jenisAnggota:'Guru/Karyawan',jumlahPeminjam:'2',jumlahMengembalikan:'2',jumlahKeterlambatan:'0'},
        {jenisAnggota:'Siswa',jumlahPeminjam:'83',jumlahMengembalikan:'83',jumlahKeterlambatan:'0'},
    ]
}

export default bulanDesember;