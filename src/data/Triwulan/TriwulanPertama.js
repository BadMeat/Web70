const triwulanPertama = {
    ...
    kunjungan: [
        {jenisAnggota: 'Guru/Karyawan', jumlahPengunjung: 52},
        {jenisAnggota: 'Siswa', jumlahPengunjung: 1095}
    ],
    sirkulasi: [
        {jenisAnggota:'Guru/Karyawan',jumlahPeminjam:'41',jumlahMengembalikan:'32',jumlahKeterlambatan:'9'},
        {jenisAnggota:'Siswa',jumlahPeminjam:'170',jumlahMengembalikan:'128',jumlahKeterlambatan:'4'},
    ]
}

export default triwulanPertama