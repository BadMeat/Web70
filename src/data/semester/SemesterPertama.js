const semesterPertama = {
    ...
    koleksi : [
        ...
        {jenisKoleksi: "VCD", jumlahJudul: 33, jumlahEksemplar: 33},
        {jenisKoleksi: "Peta", jumlahJudul: 4, jumlahEksemplar: 4},
        {jenisKoleksi: "Kaset Tipe Recorder", jumlahJudul: 0, jumlahEksemplar: 0},
    ],
    kunjungan: [
        {jenisAnggota: 'Guru/Karyawan', jumlahPengunjung: 75},
        {jenisAnggota: 'Siswa', jumlahPengunjung: 1308},
        {jenisAnggota: 'OTM', jumlahPengunjung: 873}
    ],
    sirkulasi: [
        {jenisAnggota:'Guru/Karyawan',jumlahPeminjam:'62',jumlahMengembalikan:'62',jumlahKeterlambatan:'0'},
        {jenisAnggota:'Siswa',jumlahPeminjam:'418',jumlahMengembalikan:'418',jumlahKeterlambatan:'0'},
    ]
}

export default semesterPertama